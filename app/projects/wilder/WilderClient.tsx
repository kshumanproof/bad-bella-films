...
<section className="block md:hidden">
  ...
  <div className="px-6 pt-6 pb-10">
    ...
    <p className="text-sm text-zinc-300 leading-relaxed mb-6">
      She built a new life on a lie. Now the truth wants it back.
    </p>
    ...
    <p className="text-sm text-zinc-400 leading-relaxed">
      A struggling single mother risks everything by impersonating a journalist to secure a life-changing opportunity. But as the lie deepens and the truth closes in, she’s forced to confront the cost of becoming someone she’s not.
    </p>
        ...
        <>
          ...
          <div className="block md:hidden">
            <video
              ...
              playsInline
              preload="metadata"
              poster="/images/wilder/wilder.webp"
            >
              <source src="/videos/wilder.mp4" type="video/mp4" />
            </video>
          </div>
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        ...
        {SHOW_STILL_1 && (
          <div className="aspect-[4/3] overflow-hidden rounded-lg">
            <img src="/images/Wilder.webp" className="w-full h-full object-cover" />
          </div>
        )}
