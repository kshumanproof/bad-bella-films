...
<section className="block md:hidden">
  ...
  <div className="px-6 pt-6 pb-10">
    ...
    <p className="text-sm text-zinc-300 leading-relaxed mb-6">
      Everyone’s chasing the head— no one’s ready for what it leads to.
    </p>
    ...
    <p className="text-sm text-zinc-400 leading-relaxed">
      A severed head sparks a wild chase across the frontier, pulling a mismatched crew of bounty hunters, outlaws, and drifters into a race for the truth. But as the miles stack up and the bodies follow, the hunt reveals something far more dangerous than gold—a legacy of betrayal that refuses to die.
    </p>
        ...
        <>
          ...
          <div className="block md:hidden">
            <video
              ...
              playsInline
              preload="metadata"
              poster="/images/bobbi-dupree/dupree.webp"
            >
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        ...
        {SHOW_STILL_1 && (
          <div className="aspect-[4/3] overflow-hidden rounded-lg">
            <img src="/images/bobbi-dupree/dupree.webp" className="w-full h-full object-cover" />
          </div>
        )}
