...
<section className="block md:hidden">
  ...
  <img
    src="/images/family-tradition/ft-gray-woods.jpg"
  ...
  <div className="px-6 pt-6 pb-10">
    ...
    <p className="text-sm text-zinc-300 leading-relaxed mb-6">
      One confession is all it takes to set a family’s past loose.
    </p>
    ...
    <p className="text-sm text-zinc-400 leading-relaxed">
      After their father’s funeral, a man gathers his estranged family in a quiet diner to finally tell the truth. But as buried sins and old wounds rise to the surface, his confession sets off a chain reaction that threatens to tear them apart.
    </p>
...
<section className="px-6 sm:px-10 md:px-16 py-20 md:py-28">
  ...
  <video
    ...
    playsInline
    preload="metadata"
    poster="/images/family-tradition/ft-tony.jpg"
  >
  ...
  preload="metadata"
      ...
      <img
        src="/images/family-tradition/ft-gray-knife.jpg"
        className="w-full aspect-video object-cover rounded-lg"
      />
    )}
...
<div className="grid sm:grid-cols-2 gap-6">
  ...
  <div className="aspect-[4/3] overflow-hidden rounded-lg">
    <img
      src="/images/family-tradition/ft-gray-diner.jpg"
  ...
  <div className="aspect-[4/3] overflow-hidden rounded-lg">
    <img
      src="/images/family-tradition/ft-sadie.jpg"
      className="w-full h-full object-cover"
    />
  </div>
  ...
  <div className="aspect-[4/3] overflow-hidden rounded-lg">
    <img
      src="/images/family-tradition/ft-harlan.jpg"
      className="w-full h-full object-cover"
    />
  </div>
  ...
  <div className="aspect-[4/3] overflow-hidden rounded-lg">
    <img
      src="/images/family-tradition/ft-jolene-wade.jpg"
      className="w-full h-full object-cover"
    />
  </div>
...
</section> {/* ← CLOSE MEDIA SECTION ONLY ONCE */}
