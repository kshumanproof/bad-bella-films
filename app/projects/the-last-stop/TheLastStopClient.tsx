...
const SHOW_CREDITS = true;
const SHOW_STILL_1 = true;
const SHOW_STILL_2 = true;
...
<section className="block md:hidden">
  ...
  <div className="px-6 pt-6 pb-10">
    ...
    <p className="text-sm text-zinc-300 leading-relaxed mb-6">
      A man plans his final exit—until a stranger gives him a reason to stay.
    </p>
    ...
    <p className="text-sm text-zinc-400 leading-relaxed">
      An elderly widower sets out on a quiet journey, believing he’s headed for the end of his life. But when an unexpected connection begins to take hold, it forces him to confront the past he’s avoided—and reconsider whether he’s truly ready to let go.
    </p>
        ...
        <>
          ...
          <div className="block md:hidden">
            <video
              ...
              playsInline
              preload="metadata"
              poster="/images/the-last-stop/the-last-stop-bus-stop.webp"
            >
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        ...
        {SHOW_STILL_1 && (
          <div className="aspect-[4/3] overflow-hidden rounded-lg">
            <img src="/images/the-last-stop/david-and-death.jpg" className="w-full h-full object-cover" />
          </div>
        )}

        {SHOW_STILL_2 && (
          <div className="aspect-[4/3] overflow-hidden rounded-lg">
            <img src="/images/the-last-stop/david.jpg" className="w-full h-full object-cover" />
          </div>
        )}
  ...
  <section className="px-6 sm:px-10 md:px-16 pb-20">
    ...
    <div className="max-w-5xl">
      ...
      <div className="space-y-3 text-sm sm:text-base text-zinc-400">
        <p><span className="text-white">Director:</span> Timea Shuman</p>
        <p><span className="text-white">Writer:</span> Kris Shuman</p>

        <p className="leading-relaxed">
          <span className="text-white">Cast:</span>{" "}
          Jonathan Sullivan, Joel Austin, Eden Neville, Sebastian Berry, Kashton Wilson
        </p>
      </div>
    </div>
